...
export class HUDDebugMenu extends BaseHUDPart {
    createElements(parent) {
        this.background = makeDiv(parent, "ingame_HUD_DebugMenu", ["ingameDialog"]);
    ...
    loadFromSave() {
        this.root.gameState.doLoadSave();
    }
    ...
    initialize() {
        ...
        this.inputReciever = new InputReceiver("debugmenu");
